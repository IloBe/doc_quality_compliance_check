...
class PostgreSQLInitializer:
    ...
    def verify_schema(self) -> bool:
        ...
        required_tables = {
            ...
            "skill_documents": ["document_id", "tenant_id", "filename", "workflow_status"],
            "document_locks": ["document_id", "locked_by", "locked_at", "expires_at"],
            "skill_findings": ["finding_id", "tenant_id", "document_id"],
            "audit_events": ["event_id", "event_type"],
            "user_sessions": ["session_id", "session_token_hash", "user_email"],
            "quality_observations": ["observation_id", "tenant_id", "aspect", "outcome", "source_component"],
