...
|------|-----------|-------------------|
| AI System | A machine-based system designed to operate with varying levels of autonomy | EU AI Act Art. 3(1) |
...
| Term | Definition | Source / Reference |
|------|-----------|-------------------|
| CE Marking | European conformity marking indicating product compliance | EU Regulation |
