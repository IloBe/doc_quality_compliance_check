...
import { HelpNavigationCard, getHelpAccentClass } from '../../lib/helpCenterViewModel';

type HelpNavigationCardsProps = {
  cards: HelpNavigationCard[];
};

const HelpNavigationCards = ({ cards }: HelpNavigationCardsProps) => {
  return (
        ...
        return (
          ...
          >
            <div className="flex items-start justify-between gap-4">
              <div>
                <div className={`w-11 h-11 rounded-xl mb-4 flex items-center justify-center ${getHelpAccentClass(item.accent)}`}>
...
export default HelpNavigationCards;
